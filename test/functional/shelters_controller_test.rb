...
class SheltersControllerTest < ActionController::TestCase
  ...
  test "should create shelter" do
    assert_difference('Shelter.count') do
      post :create, shelter: { city: @shelter.city, phone: @shelter.phone, sheltername: @shelter.sheltername, state: @shelter.state, street: @shelter.street, zip: @shelter.zip }
    end
  ...
  test "should update shelter" do
    put :update, id: @shelter, shelter: { city: @shelter.city, phone: @shelter.phone, sheltername: @shelter.sheltername, state: @shelter.state, street: @shelter.street, zip: @shelter.zip }
    assert_redirected_to shelter_path(assigns(:shelter))
  end
